...
public class Engine implements Runnable {
	...
	public Engine(UnitRepository repository, UnitFactory unitFactory) {
	...
	private String retire(String[] data) throws ExecutionControl.NotImplementedException {
		String unitType = data[1];
		if(this.repository.getAmountOfUnits().containsKey(unitType)) {
			if (this.repository.getAmountOfUnits().get(unitType) > 0) {
